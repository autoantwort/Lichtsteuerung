...
public:
    ...
    Q_SLOT void shouldOverrideValue(bool o) {
        if (o == shouldOverrideValue_) return;
        shouldOverrideValue_ = o;
        emit shouldOverrideValueChanged(o);
    }
