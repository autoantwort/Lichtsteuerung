...
public:
    ...
    typename std::vector<Type>::const_iterator cbegin() const { return model.cbegin(); }
    typename std::vector<Type>::const_iterator cend() const { return model.cend(); }
    typename std::vector<Type>::const_iterator begin() const { return model.begin(); }
    typename std::vector<Type>::const_iterator end() const { return model.end(); }
    typename std::vector<Type>::iterator begin() { return model.begin(); }
    typename std::vector<Type>::iterator end() { return model.end(); }
    /**
    ...
    typename std::vector<Type>::reference back() { return model.back(); }

    typename std::vector<Type>::reference operator[](int index) { return model[index]; }

    void dataChanged(int index_) { emit QAbstractItemModel::dataChanged(index(index_), index(index_)); }
    void dataChanged(int index_, int length) { emit QAbstractItemModel::dataChanged(index(index_), index(index_ + length - 1)); }

    typename std::vector<Type>::const_reference operator[](int index) const { return model[index]; }
