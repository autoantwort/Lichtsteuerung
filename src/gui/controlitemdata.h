...
public:
    ...
    enum UserVisibilityModelRoles { UserNameRole = Qt::UserRole + 1, VisibilityRole };
...
public:
    ...
    enum GroupModelRoles { EnableDataRole = ModelVector<std::unique_ptr<DMX::Device>>::ModelDataRole + 1 };
