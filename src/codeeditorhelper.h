...
public:
    ...
    CodeCompletions() { setSourceModel(&model); }
...
public:
    QAbstractItemModel *getCodeCompletions() { return &codeCompletions; }
    QAbstractItemModel *getCodeMarkups() { return &codeMarkups; }

    void setModule(Modules::Module *_module);
    Modules::Module *getModule() const { return module; }
    ...
    QQuickTextDocument *getDocument() const { return documentWrapper; }
signals:
