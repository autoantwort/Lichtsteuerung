...
MODULE_EXPORT void _supportAudio(bool b) {
    __supportAudio = b;
}
MODULE_EXPORT void _setFFTOutputView(Modules::FFTOutputView<float> *fftOutputView) {
    fftOutput = fftOutputView ? *fftOutputView : _emptyView;
}
bool supportAudio() {
    return __supportAudio;
}
#endif
...
MODULE_EXPORT void _setSpotifyState(Modules::SpotifyState const *s) {
    spotify = s ? s : &__emptySpotifyState;
}
#endif
...
MODULE_EXPORT void _setControlPoint(Modules::ControlPoint const *s) {
    controlPoint = s ? s : &__defaultControlPoint;
}
#endif
...
MODULE_EXPORT void _setGetScannerByNameCallback(std::function<Modules::IScanner *(const std::string &)> callback) {
    getScannerByNameCallback = callback;
}
MODULE_EXPORT void _setGetScannerByNameOrCreateCallback(std::function<Modules::IScanner *(const std::string &)> callback) {
    getScannerByNameOrCreateCallback = callback;
}
namespace Scanner {
...
MODULE_EXPORT void _setCreateMqttClientCallback(std::function<Modules::detail::IMqttClientImpl *()> callback) {
    createMqttClientCallback = callback;
}
Modules::detail::IMqttClientImpl *_createMqttClientImpl() {
    return createMqttClientCallback ? createMqttClientCallback() : nullptr;
}
#endif
}
