...
namespace detail {
    ...
    struct Connection {
         ...
         */
        void addTarget(length_t length, OutputDataProducer *target, unsigned int targetStartIndex) { targeds.push_back(std::pair<length_t, TargedInfo>(length, {target, targetStartIndex})); }
