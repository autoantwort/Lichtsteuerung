...
Device::Device(const QJsonObject &o):id(o),name(o["name"].toString()),desciption(o["description"].toString()),position(o["position"].toObject()["x"].toInt(),o["position"].toObject()["y"].toInt()),startDMXChannel(o["startDMXChannel"].toInt()){
